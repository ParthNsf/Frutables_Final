...
const Home = () => {
    ...
    const facilityValues = useSelector((state) => state.fruitFacilities)
        ...
        <div>
            ...
            {/* <div className="container-fluid featurs py-5">
                <div className="container py-5">
                    <div className="row g-4">
                        {
                            facilityValues.facility.map((value) => (
            ...
            <div className="container-fluid vesitable py-5">
                <div className="container py-5">
                    ...
                    <OwlCarousel {...fruitables} className="owl-carousel vegetable-carousel justify-content-center">
            ...
            <div className="container-fluid testimonial py-5">
                <div className="container py-5">
                    ...
                    <OwlCarousel {...testimonial1} className="owl-carousel testimonial-carousel">
