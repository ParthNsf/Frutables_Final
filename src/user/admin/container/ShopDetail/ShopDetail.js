...
import { displayFeedback, editReview, feedbackData, removeReview } from '../../../../redux/Action/review.action';
import Rating from '@mui/material/Rating';
import Stack from '@mui/material/Stack';
import Review from '../Review/Review';
import { addToCart } from '../../../../redux/Action/cart.action';
import { addToCarting, decrementQuantity, incrementQuantity } from '../../../../reduxToolkit/cartSlice';
...
const ShopDetail = () => {
    ...
    // const cartItems = useSelector((state) => state.cartReducerinCart)
    // console.log(cartItems);

    const cartinginshop = useSelector((state) => state.cartinToolkit)
    console.log(cartinginshop);

    const totalQuantity = cartinginshop.carting.reduce((total, item) => total + item.quantity, 0);
                                ...
                                <div className="row g-4">
                                    ...
                                    <div className="col-lg-6">
                                        ...
                                        <div className="input-group quantity mb-5" style={{ width: 100 }}>
                                            ...
                                            <span className="form-control border-0 bg-light">{count}</span>
                                            <div className="input-group-btn">
                                        ...
                                        <button onClick={handleAddInCart} className="btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary">
